...
<a href="feedback.php"  class="active"  >Feedbacks</a>
...
<?php
    ...
    if (is_object($result) && $result->num_rows > 0) {
        ...
        echo "<table><tr><th>S_No.</th><th>Name</th><th>Email</th><th>Rating</th><th>Feedback</th></tr>";
        while($row = $result->fetch_assoc()) {
            echo "<tr><td>".$row["S_no."]."</td><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["rating"]."</td><td>".$row["feedback"]."</td></tr>";
        }
        echo"</table>";
    } else {
        echo "0 results";
