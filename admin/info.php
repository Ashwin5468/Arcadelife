...
<center>
<div>
<h1 style="margin-top:291px;">Your Profile</h1>
<div class="container">
<div class="demotext">
    <center>
<img src="../imgs/icons/user.png" alt="profile" style="width :30%;">
</center>
<?php 
echo "<lbl>"."Name: "."</lbl>";
...
echo "<lbl>"."Username: "."</lbl>";
echo "<dtl>".$row['username']."<dtl>"."<br>";

echo "<lbl>"."Token Count: "."</lbl>";
...
<?php
echo "<lbl>"."Timeing: "."</lbl>";
echo "<dtl>".$roww['Timing']."<dtl>"."<br>";

echo "<lbl>"."Memebers: "."</lbl>";
